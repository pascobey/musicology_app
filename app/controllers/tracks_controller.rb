class TracksController < ApplicationController
  ...
  def create
    ...
    redirect_to controller: 'status', action: 'build', library_id: url_vars[:library_id], playlist_id: "#{url_vars[:playlist_id].to_i + 1}", access_token: url_vars[:access_token], xt: '0'
  end
